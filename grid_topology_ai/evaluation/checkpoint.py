...
def _make_task_config(request: EvaluationRequest) -> dict[str, Any]:
    ...
    try:
        reward = GridFMReward(physics_config=request.resolved_physics_config)
    except TypeError:
        # Compatibility for lightweight third-party/test reward doubles.
        reward = GridFMReward()
    reward_config = reward.config_dict()
